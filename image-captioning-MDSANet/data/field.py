...
class ImageDetectionsField(RawField):
    ...
    def preprocess(self, x, avoid_precomp=False):
        ...
        try:
            precomp_data = np.load(os.path.join(self.detections_path, str(image_id) + '.npy'), allow_pickle=True)
            precomp_data = dict(precomp_data.tolist())['grid_features']
        except KeyError:
        ...
        return {'grids': precomp_data, 'image_id': image_id}
